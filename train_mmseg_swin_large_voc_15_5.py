"""
使用 mmsegmentation 的 Swin-Large 模型训练 VOC 15-5 Step0 分阶段分割任务
...
def main(config=None):
    """主训练函数"""
    print("=" * 70)
    print("mmsegmentation Swin-Large 训练 - VOC 15-5 Step0")
    print("=" * 70)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='训练 mmsegmentation Swin-Large 模型 (VOC 15-5)')
